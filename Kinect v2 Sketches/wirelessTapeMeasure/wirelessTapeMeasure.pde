...
void mousePressed()
{
  ...
  int clickedDepth = depthValues[clickPosition];  // Index depth values based on user's click position.
  
  float inches = clickedDepth / 25.4;       // Convert millimeters to inches
